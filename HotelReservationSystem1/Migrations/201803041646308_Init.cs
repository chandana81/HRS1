namespace HotelReservationSystem1.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        BookingConfirmed = c.Boolean(nullable: false),
                        BookingCreatedOn = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ReservationDetails", "RoomReservationId", "dbo.RoomReservations");
            ...
            DropIndex("dbo.ReservationDetails", new[] { "RoomReservationId" });
